...
public:
	...
	void DrawCall1Pass(const glm::vec3& renderPos, const glm::vec3& renderLookAt, GLFWwindow* window, GLuint shaderProgramID, double deltaTime);
	void DrawCall2Pass(const std::string& renderObjName, bool isScreenQuad, GLFWwindow* window, GLuint shaderProgramID);
