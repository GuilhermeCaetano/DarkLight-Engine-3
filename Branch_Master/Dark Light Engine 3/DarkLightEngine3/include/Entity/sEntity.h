...
public:
	...
	T* GetComponent()
	{
		T* component = static_cast<T*>(nMemory::FindAllocatedMemoryFromEntity(T::GetStaticType(), this->GetName()));
	...
	void* operator new(size_t size)
	{
		...
		void* element = nMemory::InitAllocatedMemory(sEntity::GetStaticType());
		return element;
	}
