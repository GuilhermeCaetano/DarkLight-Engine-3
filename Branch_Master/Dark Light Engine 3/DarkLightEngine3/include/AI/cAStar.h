...
public:
	...
	void SetGoalNode(std::string nodeName);
	...
	bool RemakePath(const std::vector<sPathNode*>& cameFrom, sPathNode* fromNode);
...
private:
	...
	bool _IsNodeOpen(sPathNode* node);
